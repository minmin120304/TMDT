  ...
  const orderManagementData = [
    {
      ...
      children: [
        {
          key: 'completion-rate',
          metric: 'Tỷ lệ đơn hàng không thành công',
          info: true,
          myShop: '-',
          target: '<10.00%',
          previous: '-',
        ...
        {
          key: 'prep-time',
          metric: 'Thời gian chuẩn bị hàng',
          info: true,
          myShop: '-',
          target: '<1.50 ngày',
          previous: '-',
  ...
  return (
    <div className="m-5">
      <div className="">
        ...
        {/* Detail Section */}
        <Card
          title={<span className="text-lg font-semibold">Chi tiết chỉ số</span>}
          className="mb-6"
        >
          <div className="mb-4">
